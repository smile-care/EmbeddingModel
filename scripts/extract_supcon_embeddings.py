...
def main():
    ...
    parser.add_argument('--model', type=str, default="checkpoints/supcon_models/1223-2/checkpoint_epoch_20.pth",
                       help='模型checkpoint路径')
    ...
    parser.add_argument('--output', type=str, default="checkpoints/supcon_models/1223-2/extract_embeddings/4.x_val.npz",
